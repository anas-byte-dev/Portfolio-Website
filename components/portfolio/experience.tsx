...
export function Experience() {
  return (
    <section id="experience" className="relative border-y border-border/60 bg-card/20 py-24">
            ...
            {experience.map((item, i) => (
              <Reveal key={item.org} delay={i * 120}>
                <div className="relative pl-10 sm:pl-12">
                  ...
                  <motion.div
                    whileHover={{ y: -3 }}
                    className="overflow-hidden rounded-2xl border border-border/80 bg-card/80 p-6 sm:p-7 shadow-md backdrop-blur-md transition-all hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5"
                  >
